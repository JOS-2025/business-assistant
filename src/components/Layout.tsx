        ...
        {isMoreMenuOpen && (
          <>
            ...
            <motion.div
              ...
              animate={{ y: 0 }}
              exit={{ y: "100%" }}
              className="fixed bottom-0 left-0 right-0 bg-white rounded-t-[32px] z-[70] p-8 pb-12 shadow-2xl max-h-[90vh] overflow-y-auto"
            >
              ...
              <div className="grid grid-cols-2 gap-4 pb-8">
                <NavLink 
                  ...
                  onClick={() => setIsMoreMenuOpen(false)}
                  className="flex flex-col items-center gap-3 p-6 bg-slate-50 rounded-2xl hover:bg-emerald-50 hover:text-emerald-600 transition-all border border-slate-100 text-slate-500"
                >
                  <div className="w-12 h-12 bg-white rounded-xl shadow-sm flex items-center justify-center">
                    <TrendingUp className="w-6 h-6" />
                  </div>
                  <span className="text-xs font-bold uppercase tracking-wider">AI Analytics</span>
                </NavLink>
                ...
                >
                  ...
                  <span className="text-xs font-bold uppercase tracking-wider">Storefront</span>
                </NavLink>
                ...
                <NavLink 
                  to="/profile" 
                  onClick={() => setIsMoreMenuOpen(false)}
                  className="flex flex-col items-center gap-3 p-6 bg-slate-50 rounded-2xl hover:bg-emerald-50 hover:text-emerald-600 transition-all border border-slate-100 text-slate-500 col-span-2"
                >
                  <div className="w-12 h-12 bg-white rounded-xl shadow-sm flex items-center justify-center">
