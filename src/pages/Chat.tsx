...
export default function Chat() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      text: "Hi! I'm Business Assistant AI. Tell me what you sold or bought today. For example: 'Sold 5 bags of cement for 4500' or 'Bought 10 crates of soda for 6000'. I'll automatically update your stock!",
      sender: 'bot',
      timestamp: new Date()
    }
  ]);
  ...
  return (
    <div className="flex flex-col h-full bg-slate-50 max-w-md mx-auto w-full">
      <header className="bg-white border-b border-slate-200 p-4 sticky top-0 z-10 flex items-center gap-3">
        ...
        <div>
          <h1 className="font-bold text-slate-900">Business Assistant AI</h1>
